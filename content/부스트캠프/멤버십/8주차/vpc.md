...
- EC2와 같은 다양한 AWS 리소스를 VPC 내에서 실행함
    
- VPC를 더 작은 범위의 subnet으로 나눌 수 있음
    
- [https://aws.amazon.com/ko/documentation/vpc/](https://aws.amazon.com/ko/documentation/vpc/)
...
- 이전에는 사용자가 직접 생성할 수 없었으나 현재는 가능
...
- [http://docs.cloud.toast.com/ko/Infrastructure/Compute/CIDR%20Guide/](http://docs.cloud.toast.com/ko/Infrastructure/Compute/CIDR%20Guide/)
...
```
xxx.xxx.xxx.0: 네트워크 주소
xxx.xxx.xxx.1: 게이트웨이 주소
xxx.xxx.xxx.2: 예약
xxx.xxx.xxx.3: 예약
xxx.xxx.xxx.255: 브로드캐스팅 용도
```
...
- 추가로 라우팅 테이블을 생성해서 subnet에 할당 가능
...
![](http://public.codesquad.kr/honux/images/lec-vpc1.png)

## private subnet

- 인터넷으로부터의 직접 액세스가 불가능
    
- NAT 인스턴스 또는 NAT 게이트웨어를 통해 간접적으로 인터넷 가능
...
- [https://docs.aws.amazon.com/ko_kr/vpc/latest/userguide/VPC_NAT_Instance.html](https://docs.aws.amazon.com/ko_kr/vpc/latest/userguide/VPC_NAT_Instance.html)
...
![](http://public.codesquad.kr/honux/images/vpc-nat.png)
...
- 쉽고 간단  
    ![](http://public.codesquad.kr/honux/images/vpc-peering.png)
...
![](http://public.codesquad.kr/honux/images/aws-vpn.png)
...
![](http://public.codesquad.kr/honux/images/vpc-s3-end.png)
...
[http://www.e-infomax.com/ipmasq/howto-trans/kr/IP-Masquerade-HOWTO-2.html](http://www.e-infomax.com/ipmasq/howto-trans/kr/IP-Masquerade-HOWTO-2.html)

[https://www.youtube.com/watch?v=gmIsI1PhOK4](https://www.youtube.com/watch?v=gmIsI1PhOK4)