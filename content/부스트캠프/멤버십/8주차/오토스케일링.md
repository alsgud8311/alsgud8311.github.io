...
(1) IAM 아이디를 이용해서 AWS관리 콘솔에 로그인한다.

## public subnet 추가하기

(1) 기존 VPC에 public subnet이 두개 이하라면 추가 생성한다.
...
![](http://public.codesquad.kr/honux/images/elb-subnet.png)

(6) 보안 그룹 선택: elbsg 선택, next 두 번 클릭, Step 4로

(7) Step 4에서 아래와 같이 값 입력

![](http://public.codesquad.kr/honux/images/elb-health.png)
...
(7) User data 아래와 같이 입력.

잘 안 되면 해당 스크립트를 실행해서 웹서버가 설치된 AMI를 만들어서 사용하자.
...
![](http://public.codesquad.kr/honux/images/asg-alarm.png)

(5) Create a simple scaling policy 클릭, Add 1 instances 입력한다. And then wait 값은 90으로 수정한다.

(6) 같은 방식으로 Decrease Group Size 입력  
![](http://public.codesquad.kr/honux/images/asg-low.png)

![](http://public.codesquad.kr/honux/images/asg-all.png)
