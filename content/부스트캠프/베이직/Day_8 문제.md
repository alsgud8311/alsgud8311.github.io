...
1. 솔 솔리스 (Sol Solis: 태양의 날)
    
2. 솔 루나에 (Sol Lunae: 달의 날)
    
3. 솔 마르티우스 (Sol Martius: 화성의 날)
    
4. 솔 메르쿠리 (Sol Mercurii: 수성의 날)
    
5. 솔 요비스 (Sol Jovis: 목성의 날)
    
6. 솔 베네리스 (Sol Veneris: 금성의 날)
    
7. 솔 사투르니 (Sol Saturni: 토성의 날)
    

#### 1~5월, 7~11월, 13~17월, 18~23월
...
그 날짜에 해당하는 화성일을 포함하는 화성월을 표시하는 프로그램을 작성해야 합니다.
...
- 터미널 설정을 ANSI로 해놓고 ANSICode 코드를 출력하면 폰트색이나 배경색을 지정할 수도 있습니다.
    ...
    - ANSI 샘플 코드 [https://gist.github.com/godrm/95c9ac19cacd8b8d29127ce908182ae3](https://gist.github.com/godrm/95c9ac19cacd8b8d29127ce908182ae3)
